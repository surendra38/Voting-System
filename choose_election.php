    ...
    <tr>
      <td width="455" height="61"><form id="form1" method="post" action="">
        <table width="459" height="103" align="center">
          <tr>
            <td width="405" height="55"><div align="center" class="style8">PRIME MINISTER ELECTIONS </div></td>
            <td width="142"><label>
              <div align="center">
          ...
          <tr>
            <td height="40"><div align="center" class="style8">CHIEF MINISTER ELECTIONS </div></td>
            <td><div align="center">
              <input type="submit" name="Submit2" value="CHIEF MINISTER" />
            </div></td>
          </tr>
		  <tr>
            <td width="305" height="55"><div align="center" class="style8">MLA ELECTIONS </div></td>
            <td width="142"><label>
              <div align="center">
